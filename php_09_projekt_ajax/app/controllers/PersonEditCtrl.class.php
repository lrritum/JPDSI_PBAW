...
class PersonEditCtrl {
    ...
    public function validateSave() {
        ...
        $this->form->name = $v->validateFromPost('name', [
            'trim' => true,
            'required' => true,
            'required_message' => 'Podaj Markę',
            'min_length' => 2,
            'max_length' => 20,
            'validator_message' => 'Marka samochodu powinna mieć od 2 do 20 znaków'
        ]);
        ...
        $this->form->surname = $v->validateFromPost('surname', [
            ...
            'min_length' => 2,
            'max_length' => 20,
            'validator_message' => 'Model pojazdu powinien mieć od 2 do 20 znaków'
        ]);
        $date = $v->validateFromPost('birthdate', [
            'trim' => true,
            'required' => true,
            'required_message' => "Wprowadź rok wydania pojazdu",
            'date_format' => 'Y',
            'validator_message' => "Niepoprawny format. Przykład: 2006"
        ]);
        if ($v->isLastOK()) {
            $this->form->birthdate = $date->format('Y');
        }
